        ...
        },
        {
            ...
            "table": [
                ...
                [
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "1. Modify the stat to be randomly calculated between its \"min\" and \"max\" values<br>2. Sets the stat value to its \"max\" value if the item is High Quality (Superior)"
                ],
                [
                    "2",
                    {
                ...
                [
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "Consecutive calls of this function will use the same calculated value as the previous call.<br>\u00c2\u00b7 Used for modifying a single skill level<br>\u00c2\u00b7 Requires the stat's \"min\" and \"max\" values for the skill's level modification<br>\u00c2\u00b7 Requires the stat's \"parameter\" value for the skill ID"
                ],
                [
                    "10",
                    {
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "Consecutive calls of this function will use the same calculated value as the previous call.<br>\u00c2\u00b7 Used for modifying the levels of skills from a skill tab<br>\u00c2\u00b7 The skill tab level modification is defined through the calculated value<br>\u00c2\u00b7 The skill tab ID is defined through the stat's \"parameter\" value. The stat's \"parameter\" value is defined as the class ID and the number of tabs that the class has:<br>&nbsp;o 0-2 = Amazon (Bow and Crossbow Skills / Javelin and Spear Skills / Passive and Magic Skills)<br>&nbsp;o 3-5 = Sorceress (Fire Spells / Lightning Spells / Cold Spells)<br>&nbsp;o 6-8 = Necromancer (Summoning Spells / Poison and Bone Spels / Curses)<br>&nbsp;o 9-11 = Paladin (Combat Skills / Defensive Auras / Offensive Auras)<br>&nbsp;o 12-14 = Barbarian (Warcries / Combat Masteries / Combat Skills)<br>&nbsp;o 15-17 = Druid (Shape Shifting / Elemental / Summoning)<br>&nbsp;o 18-20 = Assassin (Traps / Martial Arts / Shadow Disciplines)"
                ],
                [
                    "11",
                    {
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Used for item event modifiers to cast a skill<br>\u00c2\u00b7 Requires the stat's param value as the skill ID<br>\u00c2\u00b7 Requires the stat's \"min\" value as the percent chance to cast the skill (if 0, then default to 5)<br>\u00c2\u00b7 Requires the stat's \"max\" value as the skill's level. If that level is 0 then level equals \"<code>clamp(\"item level\" - $!skills#reqlevel!$) / 4 + 1, 1, $!skills#maxlvl!$)</code>\". If that level is below 0 then level equals \"<code>max(1, (\"item level\" - $!skills#reqlevel!$) / max(1, max(1, 99 - $!skills#reqlevel!$) / -level))</code>\""
                ],
                [
                    "12",
                    {
                ...
                [
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Modify the stat to be randomly calculated between its \"min\" and \"max\" values<br>\u00c2\u00b7 Sets the stat value to its \"max\" value if the item is High Quality (Superior)<br>\u00c2\u00b7 Always sets the current durability to its maximum durability after the calculation of the stat value"
                ],
                [
                    "14",
                    {
                    ...
                    "",
                    "\u00c2\u00b7 Determines the number of sockets on an item<br>\u00c2\u00b7 If the stat has \"min\" and \"max\" values, then calculate a random number of sockets between these values. Otherwise, use the stat's \"parameter\" value as the number of sockets<br>\u00c2\u00b7 The max number of sockets depends on the stat's \"max\" size, the item's inventory grid size, or the hard cap of 6 sockets maximum"
                ],
                [
                    "15",
                    {
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Always use the stat's \"min\" value<br>\u00c2\u00b7 If the stat is physical minimum damage, then set the item's minimum damage to the stat's value. Otherwise, simply set the stat's value to its \"min\" value."
                ],
                [
                    "16",
                    {
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Always use the stat's \"max\" value<br>\u00c2\u00b7 If the stat is physical maximum damage, then set the item's maximum damage to the statss value. Otherwise, simply set the stats value to its \"max\" value."
                ],
                [
                    "17",
                    {
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Use the stat's \"parameter\" value. Otherwise, calculate a random value between the stat's \"min\" and \"max\" value. Otherwise, use 0.\u00c2\u00b7 If the stat is physical maximum damage, then set the item's maximum damage to the stat's value"
                ],
                [
                    "18",
                    {
                    ...
                    "$!#stat#!$",
                    "\u00c2\u00b7 Modifies the stat based on the current game's time of day, and the stat's preferred time period. The closer the current game's time of day is to the stat's preferred time period, then the stronger the stat's value will be, based on its \"min\" and \"max\" values<br>\u00c2\u00b7 Requires the stat's \"parameter\" value as the time period. The allowed time periods are:<br>o 0 = Day<br>o 1 = Dusk<br>o 2 = Night<br>o 3 = Dawn"
                ],
                [
                    "19",
                    {
                    ...
                    "$!#stat#!$",
                    "\u00c2\u00b7 Used for creating a stat for a charged skill.<br>\u00c2\u00b7 Requires the stat's \"parameter\" value as the skill ID<br>\u00c2\u00b7 Requires the stat's \"min\" value to calculate the value MaxCharges (maximum number of charges)<br>o If that value equals 0, then default to 5 max charges<br>o If that value is less than 0, then equal to the following calculation: \"<code>MaxCharges = |MaxCharges| + |MaxCharges| * [CURRENT ITEM LEVEL] / 8</code>\"<br>o MaxCharges cannot exceed 255<br>\u00c2\u00b7 Requires the stat's \"max\" value as the skill's level<br>\u00c2\u00b7 The spawned number of charges is calculated as the following: \"<code>Random(0 and (MaxCharges - MaxCharges / 8)) + MaxCharges / 8 + 1</code>\""
                ],
                [
                    "20",
                    {
                ...
                [
                    ...
                    "$!#stat#!$<br>$!#set#!$",
                    "\u00c2\u00b7 Modify the stat's value to be randomly calculated between its \"min\" and \"max\" values and use the stat's \"parameter\" value as the parameter<br>\u00c2\u00b7 Consecutive calls of this function will use the same stat value as the previous call"
                ],
                [
                    "25",
                    {
                ...
                [
                    ...
                    "$!#stat#!$<br>$!#set#!$<br>$!#val#!$",
                    "\u00c2\u00b7 Switches the usage of the Property \"val\" value with the stat's value<br>\u00c2\u00b7 The Property $!#val#!$ value is used as the stat value<br>\u00c2\u00b7 The stat's value (based on its \"min\" and \"max\" values) is used at the Property $!#val#!$ value"
                ]
            ]
        },
        {
